...
<body>
	...
	<div class="bannern c">
		<div class="jz c">
			...
			<div class="nbnbtz">今日关注</div>
		</div>
	</div>
	<div class="n_cont c" >
		<div class="jz c">
			<div class="ny_nav" id="my_sticky">
				<div class="wjssbt c">今天热点</div>
				<ul class="wjsndh c">
			...
			<c:if test="${today!=null}">
				<div class="ny_zqw ny_zqw_chb" id="box">
					<div class="nw_top">
						<span class="top_tzbt l">今日关注</span> <span
							class="top_mbx r">您的位置：<a href='${root}'>主页</a> > 
							><span id="title">1</span>
						</span>
					</div>
					<!--内页正文-->
					<div class="bjbld">
						<div class="xqbt">${today.title}</div>
						<div class="xqbtnm">
							<div class="xqbrq">
								<span class="rqds l">${today.pubTime }</span> <span
									class="ckrs l"><b style="font-weight: 100;"></b></span>
									 <a href="${pageContext.request.contextPath }/today/get/${columnID}"
									class="ybfh r">返回列表</a>
							</div>
						</div>
						<div class="xqxq">
							...
							<div style="text-align: center">
								<br /> <span id="title">${today.title}</span><br /> <span
									id="subTitle">${today.subtitle}</span> &nbsp;
							</div>
							<div style="text-align: left">${today.content }
								<br />
								<div style="text-align: right">
									编辑人:${today.editor}<br /> ${today.pubTime }<br /> &nbsp;
								</div>
							</div>
							<div class="xypxq">
	...
	<script type="text/javascript" src="${root}/js/today.js"></script>
