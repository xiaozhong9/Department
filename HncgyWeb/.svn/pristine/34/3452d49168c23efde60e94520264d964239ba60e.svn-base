...
<div class="page-container" id="box">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" @click="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picture_add('添加图片','${root}/uploads/img')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></span> <span class="r">共有数据：<strong v-text="page.total"></strong> 条</span> </div>
	<div class="mt-20">
			...
			<tbody>
				<tr class="text-c" v-if="imgs[0].imgName!=null" v-for="(img,index) in imgs" v-cloak>
					...
					<td><a href="javascript:;"
							@click="picture_edit('图片展示','show',img.id)"><img
