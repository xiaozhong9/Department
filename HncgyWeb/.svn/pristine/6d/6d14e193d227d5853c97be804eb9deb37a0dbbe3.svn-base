...
public class ActivityController {
	...
	public String updateState(int id){
		System.out.println("updateState================"+id);
	...
	@RequestMapping(value="remState/state",method=RequestMethod.POST)
	@ResponseBody
	public String remState(int id){
		System.out.println("remState================"+id);
		int modifyState = service.remState(id);
		if(modifyState>0){
			return "success";
		}
		return "error";
