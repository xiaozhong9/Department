	...
	<div class="page-container">
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover ">
				...
				<tbody id="body">
					<tr class="text-c va-m" v-for="(article,index) in articles">
						...
						<td class="td-manage"><a style="text-decoration:none" class="ml-5" @Click="article_del(article.aid,index)" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
				</tbody>
			</table>
		</div>
