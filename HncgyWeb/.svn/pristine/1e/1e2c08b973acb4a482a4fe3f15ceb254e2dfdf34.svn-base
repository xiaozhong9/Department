...
public class PageCtroller {
	...
	@RequestMapping("comment/administrantion")
	public String commentAdministration(){
		return "comment/comment-administration";
	}
	...
	public String activity() {
		return "index/activity/activity";
	}
	
	@RequestMapping("/activity/add")
	public String activityAddPage() {
		return "index/activity/activity-add";
	}
	@RequestMapping("/activity/edit")
	public String activityEdit() {
		return "index/activity/activity-edit";
	}
	@RequestMapping("/activity/show")
	public String activityShow() {
		return "index/activity/activity-show";
	}
