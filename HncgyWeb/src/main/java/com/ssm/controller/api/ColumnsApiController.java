...
public class ColumnsApiController extends AbstractApiController {
	...
	public ApiResponseObject getTitles() throws ApiServiceException {
		 List<Column> columnTitles = columnService.getColumnTitles();
	...
	public ApiResponseObject hotArticles(@RequestBody int columnId) throws ApiServiceException{
		List<Article> hotArticles = columnService.hotArticles(columnId);
		return responseJSON(ApiResponseEnum.SUCCESS.getCode(), ApiResponseEnum.SUCCESS.getName(), hotArticles);
	}
